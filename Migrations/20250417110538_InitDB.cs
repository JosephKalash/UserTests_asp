    ...
    public partial class InitDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    UserTestId = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAsnwers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserAsnwers_Options_OptionId",
                        column: x => x.OptionId,
                        principalTable: "Options",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserAsnwers_UserTests_UserTestId",
                        column: x => x.UserTestId,
                        principalTable: "UserTests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserAsnwers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAsnwers_OptionId",
                table: "UserAsnwers",
                column: "OptionId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAsnwers_UserId",
                table: "UserAsnwers",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAsnwers_UserTestId",
                table: "UserAsnwers",
                column: "UserTestId");
